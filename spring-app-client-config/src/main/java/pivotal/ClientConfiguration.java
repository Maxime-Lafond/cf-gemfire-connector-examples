...
//    ClientCache cache = cloud.getServiceConnector("mgac1-pcc-instance-id-1", ClientCache.class,
 //       createGemfireConnectorConfig());

    ClientCache cache = cloud.getSingletonServiceConnector(ClientCache.class,
            createGemfireConnectorConfig());
